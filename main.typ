...
しかし、ここで、ある単純な問が生まれる。
それは、代数的構造全体もまた何らかの構造を有しているのではないかという直感である。
...
圏の定義を簡単に言うならば、モノイドに似た演算が可能な箙である。
...
一般に$a^b$は$C(b, a)$と書かれ、特に$f in C(b, a)$は$b$から$a$の射と言われる。
...
#ref(<94c440b9d4ba44348cc8d3d89d0d3dee>)では具体例を通じて様々な概念が圏となることを確認する。
